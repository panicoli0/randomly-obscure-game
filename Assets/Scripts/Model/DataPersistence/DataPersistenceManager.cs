...
namespace CardMatchingGame.Model.DataPersistance
{
    public class DataPersistenceManager : MonoBehaviour
    {
        ...
        public void LoadGame()
        {
            ...
            Debug.Log("Loaded grid: " + gameData.gridStatus);
            Debug.Log("Loaded dic: " + gameData.cardsStatus);
        }
        ...
        public void SaveGame()
        {
            ...
            Debug.Log("Saved grid: " + gameData.gridStatus);
            Debug.Log("Saved dic: " + gameData.cardsStatus);
